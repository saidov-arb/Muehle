...
//                    System.out.println("Bin da. im if.");
    ...
    public void updateStatusbar() {
        if (zisGame.getPlayers()[0].getStones() > 0 || zisGame.getPlayers()[1].getStones() > 0) {
            lbl_playerone.setText("Player ♬: " + zisGame.getPlayers()[0].getStones());
            lbl_playertwo.setText("Player ☯: " + zisGame.getPlayers()[1].getStones());
        }else{
            lbl_playerone.setText("Player ♬");
            lbl_playertwo.setText("Player ☯");
        }
        ...
        if (zisGame.getPlayers()[0].getStones() < 1 && zisGame.getPlayers()[1].getStones() < 1) {
            if (zisGame.checkForWinner() != 0) {
                if (zisGame.checkForWinner() == 1)
                {
                    lbl_status.setText("Player ♬ wins.");
                    changeButtonAction("null");
                } else if (zisGame.checkForWinner() == 2)
                {
                    lbl_status.setText("Player ☯ wins.");
                    changeButtonAction("null");
                }
